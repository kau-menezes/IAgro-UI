...
import { IconLayoutDashboard, IconSeedling, IconUsers, IconSettings } from '@tabler/icons-react';
    ...
    <div className="flex h-screen flex-col font-josefin">
      ...
      <div className="h-[90%] flex">
        <aside className="flex flex-col items-center h-full w-[20%] min-w-[300px] bg-white p-4 border-r-1 border-gray-300 overflow-y-auto">
          <div className='flex flex-col gap-4 items-center w-full h-[80%]'>
          ...
          <div className='flex flex-col justify-start w-full h-[20%]  '>
            ...
            <div>
              <ButtonItem text={'Settings'} color={'mainGray'} hoverColorBg={'darkerGray'} hoverColorText={''} icon={IconSettings}/>
            </div>
          </div>
        </aside>
